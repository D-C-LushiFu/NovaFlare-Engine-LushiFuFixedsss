	...
	override function create()
	{
		...
		if (modsList.all.length < 1)
		{
			...
			if (FlxG.random.bool(0.1))
				noModsTxt.text += '\nBITCH.'; // meanie
			noModsTxt.setFormat(Paths.font(Language.get('fontName', 'main') + '.ttf'), 32, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
			noModsTxt.borderSize = 2;
			add(noModsTxt);
			noModsTxt.screenCenter(Y);

			var txt = new FlxText(bgList.x + 15, bgList.y + 15, bgList.width - 30, "No Mods found.", 16);
			txt.setFormat(Paths.font(Language.get('fontName', 'main') + '.ttf'), 16, FlxColor.WHITE);
			add(txt);
		...
		modDesc.setFormat(Paths.font(Language.get('fontName', 'main') + '.ttf'), 24, FlxColor.WHITE, LEFT);
		add(modDesc);
		...
		modRestartText.setFormat(Paths.font(Language.get('fontName', 'main') + '.ttf'), 16, FlxColor.WHITE, RIGHT);
		add(modRestartText);
...
class ModItem extends FlxSpriteGroup
{
	...
	public function new(folder:String)
	{
		...
		text.setFormat(Paths.font(Language.get('fontName', 'main') + '.ttf'), 16, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		text.borderSize = 2;
